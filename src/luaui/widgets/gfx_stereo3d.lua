...
options_section = 'Effects'
options = {
	--order = { 'toggle3d', 'helpwindow', 'lblblank1', 'lblsettings', 'swapeyes', 'lasersight', 'hidecursor', 'sep', 'conv', 'lblblank2', 's3dmode', 'lblblank3', 'camera' },
	order = { 'toggle3d', 'helpwindow', 'lblblank1', 'lblsettings', 'swapeyes', 'lasersight', 'hidecursor', 'sep', 'conv', 'lblblank2', 's3dmode', 'lblblank3', 'viewta', 'viewrot', 'viewfree', },
	...
	viewta 		= { name = 'TA Cam', type = 'button', OnChange = function() spSendCommands{'viewta'} end },
...
function widget:Initialize()
	if (canShader) then
	  	stereoShader = gl.CreateShader({
			fragment = [[
				uniform mat3x3 colorleft;
				uniform mat3x3 colorright;
