unitDef = {
  ...
  customParams        = {
    ...
    helptext       = [[As a raider, the Bandit sacrifices raw firepower for survivability. It is somewhat tougher than its Nova counterpart, but still not something that you hurl against entrenched forces. Counter with riot units and LLTs.]],
