unitDef = {
  ...
  customParams          = {
    fireproof = [[1]],
    helptext  = [[The Logos Builder Commander comes with an upgraded power core, allowing it to build faster, at higher range, and with more self-produced resources and storage.]],
  },
...
return lowerkeys({ corcomOTAunitBUILD2 = unitDef })
