unitDef = {
  ...
  customParams        = {
    ...
    helptext       = [[The Shadow drops a single high damage, low AoE bomb. Cost for cost, nothing quite matches it for taking out that antinuke or HLT, but you should look elsewhere for something to use against mobile armies.]],
