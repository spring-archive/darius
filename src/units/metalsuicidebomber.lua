...
unitDef = {
  unitname               = [[metalsuicidebomber]],
  name                   = [[MetalSuicide Bomber]],
  description            = [[MetalSuicide Bomber]],
  acceleration           = 0,
  activateWhenBuilt      = false,
  bmcode                 = [[0]],
  brakeRate              = 0,
  buildPic               = [[novallt.png]],
  canAttack              = true,
  canstop                = [[1]],
  category               = [[SINK]],
...
return lowerkeys({ metalsuicidebomber = unitDef })
