...
unitDef = {
  unitname               = [[seisesspecialsuicidebomber]],
  name                   = [[Seise's specialSuicide Bomber]],
  description            = [[Seise's specialSuicide Bomber]],
  acceleration           = 0,
...
return lowerkeys({ seisesspecialsuicidebomber = unitDef })
